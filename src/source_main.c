...
const unsigned char code _CicSeed = CIC6102_SEED;

const unsigned char code _CicChecksum[] = {
    CIC6102_CHECKSUM
};


/* NTSC initial RAM */
const unsigned char code _CicRamInitNtsc[] = {
...
/* PAL initial RAM */
const unsigned char code _CicRamInitPal[] = {
